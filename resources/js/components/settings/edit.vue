								...
								<div class="card">
									<div class="card-header pt-5">
										<div class="card-title d-flex flex-column">
											...
											<!--begin::Title-->
											<span class="pt-1 fw-semibold fs-6">Edit Setting</span>
											<!--end::Title-->
											</div>
											<!--end::Info-->
										</div>
									...
									<div class="card-body">
										<form @submit.prevent="update">
											...
											<button type="submit" class="btn btn-primary" v-if="isEditing === false">Edit</button>
											<button type="button" class="btn btn-primary" v-else>Editing <span class="spinner-border spinner-border-sm align-middle text-white mr-2"></span></button>
										</form>
									</div>
								</div>
							</div>
...
name = singleSettingItem.all.name
description = singleSettingItem.all.description
type = singleSettingItem.all.type

const update = async ()=> {
        Csrf.getCookie();
        isEditing.value = true;
        http.post(`${baseURL}/settings/${id}`, {
            'name': name,
            'type' : type,
